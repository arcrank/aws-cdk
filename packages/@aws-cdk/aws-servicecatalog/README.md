...
An event notification constraint allows users to subscribe a list of AWS `SNS` topics to stack events of the product.
You can subscribe groups of topics separately to organize or group them.
